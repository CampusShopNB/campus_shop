...
/*===============================个人中心----商品管理--商品清单start=================================*/
    ...
    public String toeditgoods(@PathVariable("commid")String commid, HttpSession session, ModelMap modelMap){        ///下面这段用shiro判断用户是否登录？？
        ///下面这段用shiro判断用户是否登录？？
        /*String userid = (String)session.getAttribute("userid");
        if(userid==null){
            return "redirect:/:";
        ...
        //LookGoodImages查询某个商品的其他图（与商品的主图相对）
