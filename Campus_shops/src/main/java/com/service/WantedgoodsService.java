...
public class WantedgoodsService {
     ...
     * ①用户中心。分页查看不同状态的求购记录
     * ②首页的列表也用此方法 */
    public List<Wantedgoods> queryWantgoodsByStatus(Integer page,Integer count,Integer wantstatus) {
        return wantedgoodsMapper.queryWantgoodsByStatus(page,count,wantstatus);
    }
