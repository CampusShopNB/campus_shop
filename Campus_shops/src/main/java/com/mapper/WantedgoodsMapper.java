...
public interface WantedgoodsMapper {
    ...
    /**用户中心分页查看不同状态的求购记录 */
    List<Wantedgoods> queryWantgoodsByStatus(@Param("page") Integer page, @Param("count") Integer count, @Param("wantstatus")Integer wantstatus, @Param("userid")String userid);
